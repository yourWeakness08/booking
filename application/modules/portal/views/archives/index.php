            ...
            <div class="card-body">
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-3 col-md-3 col-sm-12 mb-sm-3">
                        <h3>Archives Masterfile</h3>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <div class="input-group mb-5 form-control-sm">
                            <span class="input-group-text"><i class="bi bi-search"></i></span>
                            <input type="text" id="archiveSearch" class="form-control form-control-sm" placeholder="Search" aria-label="Search"/>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="archive-table" class="table table-row-bordered">
                        <thead>
                            <tr class="fs-6">
                                <th class="fw-bold" width="50%">Name</th>
                                <th class="fw-bold" width="20%">User</th>
                                <th class="fw-bold" width="15%">Date Archived</th>
